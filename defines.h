...
/*
 1024				// Arduino Uno has 1024Kb of NVRAM
 966	58	OPTIONS
 960	6	SPE
 954	6	SEQ
 948	6	DIS
...
#define MAX_NUM_STATIONS  8  // maximum number of stations

#define NVM_SIZE            1024  // For AVR, nvm data is stored in EEPROM, ATmega644 has 2K EEPROM
#define STATION_NAME_SIZE   12    // maximum number of characters in each station name

#define MAX_PROGRAMDATA     694   // program data
#define MAX_NVCONDATA       12     // non-volatile controller data
#define MAX_USER_PASSWORD   36    // user password
#define MAX_LOCATION        30    // location string
#define MAX_JAVASCRIPTURL   32    // javascript url
#define MAX_WEATHERURL      30    // weather script url
#define MAX_WEATHER_KEY     24    // weather api key,
...
#else
#define ETHER_BUFFER_SIZE   592  // ATmega644 has 4K RAM, so use a smaller buffer
#endif
#endif
